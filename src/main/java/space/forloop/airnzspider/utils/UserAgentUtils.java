package space.forloop.airnzspider.utils;
...
public class UserAgentUtils {
  ...
  public static String getRandomUserAgent() {
    final var rand = Math.random() * 100;
    var count = 0.0;

    String browser = null;

    for (final var freq : frequency.entrySet()) {
      count += freq.getValue();
      if (rand <= count) {
        browser = freq.getKey();
        break;
    ...
    final var userAgents = UserAgentUtils.userAgents.get(browser);
